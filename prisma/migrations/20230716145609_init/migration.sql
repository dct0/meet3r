...
-- AddForeignKey
ALTER TABLE "Availability" ADD CONSTRAINT "Availability_meetId_fkey" FOREIGN KEY ("meetId") REFERENCES "Meet"("id") ON DELETE CASCADE ON UPDATE CASCADE;
